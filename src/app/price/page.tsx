    ...
    return (
        <div className="mt-20">
            ...
            <div className="w-full grid lg:grid-cols-3 lg:grid-rows-1 grid-cols-1 gap-10 p-10">
                <PricingCard title="Lite" subtitle="Perfect for getting started with basic guidance." price="Free" features={['Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble']} buttonText="Enroll now"/>
                <PricingCard title="Starter" subtitle="Your go-to for personalized software help and learning. " price="12.99$" features={['Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble']} buttonText="Enroll now"/>
                <PricingCard title="Business" subtitle="Unlock full functionality for teams and creators. " price="39.99$" features={['Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble','Screen recording & cam bubble']} buttonText="Enroll now"/>
            </div>
            <h1 className='text-7xl font-normal text-white text-center font-FjallaOne mt-8 mb-6'>A small Price for a great value</h1>
